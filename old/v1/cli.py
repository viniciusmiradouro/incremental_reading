...
arg_group.add_argument('-s', '--change_status', action='store', nargs=2)
arg_group.add_argument('-T', '--change_type', action='store', type=str, nargs=2)
arg_group.add_argument('-P', '--change_priority', action='store', nargs=2)
arg_group.add_argument('-p', '--postpone', action='store_true')
